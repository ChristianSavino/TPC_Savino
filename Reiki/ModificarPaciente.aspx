<%@ Page Title="" Language="C#" MasterPageFile="~/Pacientes.master" AutoEventWireup="true" CodeFile="ModificarPaciente.aspx.cs" Inherits="ModificarPaciente" %>
        ...
        <div class="card border-primary">
            <div class="card-body">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnagregar" runat="server" Text="Registrarse" CssClass="btn btn-outline-secondary" OnClick="btnActualizar_Onclick" />
                </div>
            </div>
        </div>
    </div>
