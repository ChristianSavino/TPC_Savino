<%@ Page Language="C#" MasterPageFile="~/Reiki.master" AutoEventWireup="true" CodeFile="ModificarReikis.aspx.cs" Inherits="ModificarReikis" %>
        ...
        <div class="card border-primary">
            <div class="card-body">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnmodificar" runat="server" Text="Actualizar" CssClass="btn btn-outline-secondary" Onclick="btnmodificar_Click" />
                </div> 
            </div>
        </div>
    </div>
